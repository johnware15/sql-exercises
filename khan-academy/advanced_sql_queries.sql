...
SELECT * FROM top_movies WHERE studio = "WB" AND studio = "Sony";

SELECT domestic_money, COUNT(*)
    FROM top_movies WHERE studio = "WB";

SELECT overseas_money, overseas_percent FROM top_movies GROUP BY title HAVING studio = "Uni";
